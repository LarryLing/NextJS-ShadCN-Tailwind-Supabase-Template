                ...
                <form action={ action }>
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <Button disabled={ pending } className="w-full bg-google hover:bg-google/90 text-background">
                                Login With Google
                                <GoogleIcon className="size-6"/>
                            </Button>
                            <Button disabled={ pending } className="w-full bg-discord hover:bg-discord/90 text-background">
                                Login With Discord
                                <DiscordIcon className="size-6"/>
                            </Button>
                            <Button disabled={ pending } className="w-full bg-github hover:bg-github/90 text-background">
                                Login With Github
